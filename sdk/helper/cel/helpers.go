...
func CheckValidEmailFunction() celgo.EnvOption {
	return celgo.Function("check_valid_email",
...
func CelGoExtFunctions() []celgo.EnvOption {
	var options []celgo.EnvOption

	options = append(options, ext.Strings())
	options = append(options, ext.Lists())
	options = append(options, celgo.OptionalTypes())
