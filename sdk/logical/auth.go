...
type Auth struct {
	...
	// request requires filtering of the response keys and keysInfo values
	// for entries that are readable by the current token.
	ResponseKeysFilterPath string `json:"response_keys_filter_path"`
}
